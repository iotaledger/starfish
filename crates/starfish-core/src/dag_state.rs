...
pub struct DagState {
    ...
    /// Signature scheme every received block must be authenticated with.
...
impl DagStateInner {
    ...
    fn prune_certificate_state(&mut self) {
        ...
        // Prune SailfishPlusPlus vertex certificates.
        for auth in 0..self.committee_size {
            let split_ref = BlockReference {
                authority: auth as AuthorityIndex,
                round: self.evicted_rounds[auth],
...
mod tests {
    ...
    use crate::{
        ...
        committee::Committee,
        config::{DisseminationMode, StorageBackend},
        crypto::{BLS_SIGNATURE_SIZE, BlockDigest, BlsSignatureBytes, TransactionsCommitment},
        data::Data,
        metrics::Metrics,
        types::{
            AuthorityIndex,
