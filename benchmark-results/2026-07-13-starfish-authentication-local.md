...
Date: 2026-07-13  
Source revision: `92a3d85` plus the benchmark shutdown fix committed with this report  
...
- Default protocol dissemination modes (`push-useful` for both families)
...
- The MAC variants remained close to Ed25519: TPS was within 3%, BPS within
  2.1%, and bandwidth was slightly lower in this sample. The latency changes
  are small enough that repeated runs are needed before treating their sign as
  meaningful.
- ML-DSA-44 materially increased latency and bandwidth. Its signature is 2,420
  ...
  for Starfish and 2.7x for Starfish Speed.
...
- All variants achieved roughly 433–454 TPS from the 1,000 tx/s offered load.
...
The validation run and all six measured runs exited normally.
